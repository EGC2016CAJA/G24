...
<head>
    ...
    <link href='{{asset('css/theme-flattop.css')}}' rel='stylesheet' type='text/css'/>
...
<div id='header'>
        <div class="swagger-ui-wrap">
            <h1 class="api-tittle">Autorización y Almacenamiento</h1>
            <form id='api_selector'>
                <div class='input'><input  placeholder="http://example.com/api" id="input_baseUrl" name="baseUrl" type="hidden"/></div>
                <div class='input'><input placeholder="Introduzca un token valido..." id="input_apiKey" name="apiKey" type="text"/></div>
                <div class='input'><a id="explore" href="#" data-sw-translate>Autorizar acceso</a></div>
            </form>
        </div>
</div>
